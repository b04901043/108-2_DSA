...
int Bob_play(int play_num,const card AA[],const card BB[], int num,int alpha, int beta){
    ...
    if(play_num!=-1){
        ...
        if(A[play_num].suit=='C') c.append("00");
        else if(A[play_num].suit=='D') c.append("01");
        else if(A[play_num].suit=='H') c.append("10");
        else if(A[play_num].suit=='S') c.append("11");

        if(A[play_num].number==1) c.append("0000");
        else if(A[play_num].number==2) c.append("0001");
        else if(A[play_num].number==3) c.append("0010");
        else if(A[play_num].number==4) c.append("0011");
        else if(A[play_num].number==5) c.append("0100");
        else if(A[play_num].number==6) c.append("0101");
        else if(A[play_num].number==7) c.append("0110");
        else if(A[play_num].number==8) c.append("0111");
        else if(A[play_num].number==9) c.append("1000");
        else if(A[play_num].number==10) c.append("1001");
        else if(A[play_num].number==11) c.append("1010");
        else if(A[play_num].number==12) c.append("1011");
        else if(A[play_num].number==13) c.append("1100");
        string d(c);
