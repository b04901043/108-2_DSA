...
{ 
   ...
   // cout<<pCrawl<<"-->";
    ...
    pCrawl->father[3] = pCrawl->father[2]->father[1];
    pCrawl->father[4] = pCrawl->father[2]->father[2];
    pCrawl->father[5] = pCrawl->father[3]->father[2];
    pCrawl->father[6] = pCrawl->father[3]->father[3];
    pCrawl->father[7] = pCrawl->father[4]->father[3];
    pCrawl->father[8] = pCrawl->father[4]->father[4];
    pCrawl->father[9] = pCrawl->father[5]->father[4];
    pCrawl->father[10] = pCrawl->father[5]->father[5];
    pCrawl->father[11] = pCrawl->father[6]->father[5];
    pCrawl->father[12] = pCrawl->father[6]->father[6];
    pCrawl->father[13] = pCrawl->father[7]->father[6];
    pCrawl->father[14] = pCrawl->father[7]->father[7];
    pCrawl->father[15] = pCrawl->father[8]->father[7];
    pCrawl->father[16] = pCrawl->father[8]->father[8];
    pCrawl->father[17] = pCrawl->father[9]->father[8];
...
int LCP(struct TrieNode *com1,struct TrieNode *com2){
 ...
 //   cout<<com1->depth <<" "<<com2->depth<<endl;
    for(int i=17;i>=0;i--){
